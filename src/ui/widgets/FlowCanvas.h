...
public:
    ...
    // 连接操作
    void addConnection(const QString& fromNodeId, int fromPort, const QString& toNodeId, int toPort);
...
public:
    explicit FlowConnectionItem(FlowNodeItem* fromNode, int fromPort, FlowNodeItem* toNode, int toPort,
                                QGraphicsItem* parent = nullptr);
