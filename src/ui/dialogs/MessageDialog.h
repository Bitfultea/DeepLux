...
enum class MsgType { Info, Warning, Error, Question };
...
public:
    ...
    MsgType messageBoxShow(const QString& message, MsgType type, QMessageBox::StandardButtons buttons,
                           bool modal = true);
    ...
    Q_INVOKABLE int question(const QString& message,
