...
struct CellAttributes {
    ...
    bool operator==(const CellAttributes& other) const {
        return bold == other.bold && dim == other.dim && italic == other.italic && underline == other.underline &&
               strikethrough == other.strikethrough && reverse == other.reverse && fgType == other.fgType &&
               fgValue == other.fgValue && bgType == other.bgType && bgValue == other.bgValue;
    }
