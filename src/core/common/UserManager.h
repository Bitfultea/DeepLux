...
public:
    ...
    bool isLoggedIn() const {
        return m_currentUser.isLoggedIn;
    }
    ...
    bool isDeveloper() const {
        return m_currentUser.type == UserType::Developer;
    }
    bool isAdministrator() const {
        return m_currentUser.type == UserType::Administrator;
    }
    bool isOperator() const {
        return m_currentUser.type == UserType::Operator;
    }
