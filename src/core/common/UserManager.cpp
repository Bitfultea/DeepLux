...
bool UserManager::hasPermission(const QString& permission) const {
    if (permission == "CameraSet")
        return m_permissions.cameraSet;
    if (permission == "QuickMode")
        return m_permissions.quickMode;
    if (permission == "HardwareConfig")
        return m_permissions.hardwareConfig;
    if (permission == "CommunicationSet")
        return m_permissions.communicationSet;
    if (permission == "Camera")
        return m_permissions.camera;
    if (permission == "Barcode")
        return m_permissions.barcode;
    if (permission == "ServoDebug")
        return m_permissions.servoDebug;
    if (permission == "IODebug")
        return m_permissions.ioDebug;
    if (permission == "Home")
        return m_permissions.home;
    if (permission == "Open")
        return m_permissions.open;
    if (permission == "Edit")
        return m_permissions.edit;
    if (permission == "Save")
        return m_permissions.save;
    if (permission == "RunOnce")
        return m_permissions.runOnce;
    if (permission == "RunCycle")
        return m_permissions.runCycle;
    if (permission == "Stop")
        return m_permissions.stop;
    if (permission == "OpenFile")
        return m_permissions.openFile;
    if (permission == "SaveFile")
        return m_permissions.saveFile;
    if (permission == "SystemConfig")
        return m_permissions.systemConfig;
    if (permission == "DeviceParam")
        return m_permissions.deviceParam;
    if (permission == "SystemParam")
        return m_permissions.systemParam;
    if (permission == "View")
        return m_permissions.view;
    if (permission == "NewSolution")
        return m_permissions.newSolution;
    if (permission == "SolutionList")
        return m_permissions.solutionList;
    if (permission == "GlobalVar")
        return m_permissions.globalVar;
    if (permission == "UIDesign")
        return m_permissions.uiDesign;
    return false;
}
