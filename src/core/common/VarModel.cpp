...
VarModel::VarModel(const QString& name, VarDataType type, QVariant value, QObject* parent)
    : QObject(parent), m_name(name), m_dataType(type), m_value(value) {}
...
QString VarModel::dataTypeToString(VarDataType type) {
    ...
    case VarDataType::Bool:
        return "bool";
    case VarDataType::IntArray:
        return "int[]";
    case VarDataType::DoubleArray:
        return "double[]";
    case VarDataType::StringArray:
        return "string[]";
    case VarDataType::BoolArray:
        return "bool[]";
    case VarDataType::Image:
        return "Image";
    case VarDataType::Region:
        return "Region";
    case VarDataType::Point:
        return "Point";
    case VarDataType::Line:
        return "Line";
    case VarDataType::Circle:
        return "Circle";
    case VarDataType::Rect:
        return "Rect";
    default:
        return "None";
    }
...
VarDataType VarModel::stringToDataType(const QString& str) {
    if (str == "int")
        return VarDataType::Int;
    if (str == "double")
        return VarDataType::Double;
    if (str == "string")
        return VarDataType::String;
    if (str == "bool")
        return VarDataType::Bool;
    if (str == "int[]")
        return VarDataType::IntArray;
    if (str == "double[]")
        return VarDataType::DoubleArray;
    if (str == "string[]")
        return VarDataType::StringArray;
    if (str == "bool[]")
        return VarDataType::BoolArray;
    if (str == "Image")
        return VarDataType::Image;
    if (str == "Region")
        return VarDataType::Region;
    if (str == "Point")
        return VarDataType::Point;
    if (str == "Line")
        return VarDataType::Line;
    if (str == "Circle")
        return VarDataType::Circle;
    if (str == "Rect")
        return VarDataType::Rect;
