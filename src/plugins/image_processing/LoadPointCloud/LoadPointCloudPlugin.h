...
public:
    ...
    QString moduleId() const override { return "com.deeplux.plugin.loadpointcloud"; }
    QString name() const override { return tr("加载点云"); }
    QString category() const override { return "image_processing"; }
    QString version() const override { return "1.0.0"; }
    QString author() const override { return "DeepLux Team"; }
    QString description() const override { return tr("加载 PLY 或 TIFF 点云文件"); }
