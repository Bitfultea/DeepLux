...
| DiplayData | `02Plugins/001图像处理/Plugin.DiplayData` | DisplayData | candidate |
...
| BarcodeReader | `02Plugins/002检测识别/Plugin.BarcodeReader` | QRCode | candidate |
...
| DistanceLL | `02Plugins/003几何测量/Plugin.DistanceLL` | LinesDistance | candidate |
...
| MeasureCalib | `02Plugins/005坐标标定/Plugin.MeasureCalib` | NPointCalibration | candidate |
| NPointCal | `02Plugins/005坐标标定/Plugin.NPointCal` | NPointCalibration | candidate |
